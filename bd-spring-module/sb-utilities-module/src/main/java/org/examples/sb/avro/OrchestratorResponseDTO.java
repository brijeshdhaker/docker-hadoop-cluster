...
public class OrchestratorResponseDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  private org.examples.sb.avro.OrderStatus status;
   ...
   */
  public OrchestratorResponseDTO(java.lang.String orderId, java.lang.Integer userId, java.lang.Integer productId, java.lang.Double amount, org.examples.sb.avro.OrderStatus status) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: status = (org.examples.sb.avro.OrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public org.examples.sb.avro.OrderStatus getStatus() {
    return status;
  }
   ...
   * @param value the value to set.
   */
  public void setStatus(org.examples.sb.avro.OrderStatus value) {
    this.status = value;
  }
   ...
   */
  public static org.examples.sb.avro.OrchestratorResponseDTO.Builder newBuilder() {
    return new org.examples.sb.avro.OrchestratorResponseDTO.Builder();
  }
   ...
   * @return A new OrchestratorResponseDTO RecordBuilder
   */
  public static org.examples.sb.avro.OrchestratorResponseDTO.Builder newBuilder(org.examples.sb.avro.OrchestratorResponseDTO.Builder other) {
    if (other == null) {
      return new org.examples.sb.avro.OrchestratorResponseDTO.Builder();
    } else {
      return new org.examples.sb.avro.OrchestratorResponseDTO.Builder(other);
    }
  }
   ...
   * @return A new OrchestratorResponseDTO RecordBuilder
   */
  public static org.examples.sb.avro.OrchestratorResponseDTO.Builder newBuilder(org.examples.sb.avro.OrchestratorResponseDTO other) {
    if (other == null) {
      return new org.examples.sb.avro.OrchestratorResponseDTO.Builder();
    } else {
      return new org.examples.sb.avro.OrchestratorResponseDTO.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrchestratorResponseDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.examples.sb.avro.OrchestratorResponseDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.examples.sb.avro.OrchestratorResponseDTO other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder setUserId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder setProductId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder clearProductId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder setAmount(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder clearAmount() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder setStatus(org.examples.sb.avro.OrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.examples.sb.avro.OrchestratorResponseDTO.Builder clearStatus() {
      status = null;
    ...
    public OrchestratorResponseDTO build() {
      try {
        ...
        record.status = fieldSetFlags()[4] ? this.status : (org.examples.sb.avro.OrderStatus) defaultValue(fields()[4]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      this.status = org.examples.sb.avro.OrderStatus.values()[in.readEnum()];

...
# export HBASE_OPTS="$HBASE_OPTS -Dhbase.log.dir=/apps/var/log/hbase -Djava.security.auth.login.config=/opt/hbase/conf/zookeeper-jaas.conf -Djava.security.krb5.conf=/etc/kerberos/krb5.conf"
export HBASE_OPTS="-Dhbase.log.dir=/apps/var/log/hbase -Djava.security.auth.login.config=/opt/hbase/conf/zookeeper_jaas.conf -Dzookeeper.clientCnxnSocket=org.apache.zookeeper.ClientCnxnSocketNetty -Dzookeeper.client.secure=true"

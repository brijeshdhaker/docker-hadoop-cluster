...
export ZEPPELIN_LOG_DIR=/apps/hostpath/zeppelin/logs                       # Where log files are stored.  PWD by default.
# export ZEPPELIN_PID_DIR                       # The pid files are stored. ${ZEPPELIN_HOME}/run by default.
# export ZEPPELIN_WAR_TEMPDIR                   # The location of jetty temporary directory.
export ZEPPELIN_NOTEBOOK_DIR=/apps/hostpath/zeppelin/notebook                 # Where notebook saved
...
export DOCKER_TIME_ZONE="Asia/Kolkata" # Set to the same time zone as the zeppelin server. E.g, "America/New_York" or "Asia/Kolkata"
...
##
export SPARK_HOME=/apps/spark-3.1.2             # (required) When it is defined, load it instead of Zeppelin embedded Spark libraries
...
export HADOOP_CONF_DIR=/apps/hadoop-3.2.1/etc/hadoop                        # yarn-site.xml is located in configuration directory in HADOOP_CONF_DIR.

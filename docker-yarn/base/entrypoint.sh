...
configure /opt/hadoop/etc/hadoop/core-site.xml core CORE_SITE
configure /opt/hadoop/etc/hadoop/hdfs-site.xml hdfs HDFS_SITE
configure /opt/hadoop/etc/hadoop/yarn-site.xml yarn YARN_SITE
configure /opt/hadoop/etc/hadoop/httpfs-site.xml httpfs HTTPFS_SITE
configure /opt/hadoop/etc/hadoop/kms-site.xml kms KMS_SITE
configure /opt/hadoop/etc/hadoop/mapred-site.xml mapred MAPRED_SITE

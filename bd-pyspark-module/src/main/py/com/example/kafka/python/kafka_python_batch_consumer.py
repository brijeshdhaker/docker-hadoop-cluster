...
docker-compose -f dc-kafka-cluster.yaml exec kafka-broker.sandbox.net kafka-console-consumer --bootstrap-server kafka-broker.sandbox.net:9092 --topic kafka-json-topic --from-beginning --max-messages 100

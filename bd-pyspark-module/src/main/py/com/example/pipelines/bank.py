...
class BankPipeline:
    ...
    def implement_etl(self, config):
        ...
        accounts = self.spark.read.parquet("./resources/datasets/silver/accounts/")
        customers = self.spark.read.parquet("./resources/datasets/silver/customers/")
        transactions = self.spark.read.parquet("./resources/datasets/silver/transactions/")
...
if __name__ == '__main__':
    ...
    file = Path(__file__)
    config_feed = "./resources/config/bank.json"

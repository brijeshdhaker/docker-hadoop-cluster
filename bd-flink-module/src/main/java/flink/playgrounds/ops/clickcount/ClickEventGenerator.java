...
import flink.playgrounds.ops.clickcount.records.ClickEventSerializationSchema;
...
import static flink.playgrounds.ops.clickcount.ClickEventCount.WINDOW_SIZE;
...
public class ClickEventGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		String topic = params.get("topic", "click-event-source");

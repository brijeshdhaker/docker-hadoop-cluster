package org.examples.flink.frauds;
...
import org.examples.flink.frauds.models.AlertType;
...
import static org.examples.flink.frauds.config.AppConfig.buildSecurityProps;
import static org.examples.flink.frauds.utils.StreamingUtils.createKafkaAlertSink;
import static org.examples.flink.frauds.utils.StreamingUtils.createTxnConsumer;

/*
--app-config fraud_transactions_workflow.properties --engine-type local-cluster --table-name transactions --config-path ${HOME}/IdeaProjects/docker-hadoop-cluster/bd-flink-module/src/main/resources/local-cluster

*/
public class FraudulentTxnDetector extends AbstractFlinkStreamWorkflow {

    FraudulentTxnDetector(WorkflowConfig workflowConfig){
    ...
    public static void main(String[] args) throws Exception {
        ...
        FraudulentTxnDetector streamWorkflow = new FraudulentTxnDetector(workflowConfig);
    ...
    public StreamExecutionEnvironment createPipeline() throws Exception {
        ...
        StreamExecutionEnvironment environment = flinkSession();

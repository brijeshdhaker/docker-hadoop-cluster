...
then
    ...
    #
    export HBASE_HOME=/opt/hbase-3.0.0
    ...
    export HADOOP_MAPRED_HOME=/opt/hadoop-3.2.4
    export HADOOP_COMMON_HOME=/opt/hadoop-3.2.4
    #export HADOOP_HDFS_HOME=/opt/hadoop-3.2.4
    export YARN_HOME=/opt/hadoop-3.2.4

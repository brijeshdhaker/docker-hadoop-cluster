...
docker volume create --name sandbox3_schema_registry_secrets --opt type=none --opt device=/d/apps/hostpath/sandbox3/schema-registry/secrets --opt o=bind
docker volume create --name sandbox3_schema_registry_data --opt type=none --opt device=/d/apps/hostpath/sandbox3/schema-registry/data --opt o=bind
docker volume create --name sandbox3_schema_registry_log --opt type=none --opt device=/d/apps/hostpath/sandbox3/schema-registry/log --opt o=bind
